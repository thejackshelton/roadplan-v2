...
var vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
  ...
  function expectProjection() {
    ...
    if (vCurrent == null) {
      ...
      import_build5.isDev && vnode_setProp(vNewNode, DEBUG_TYPE, "P" /* Projection */);
      import_build5.isDev && vnode_setProp(vNewNode, "q:code", "expectProjection");
  ...
  function expectSlot() {
    ...
    if (vProjectedNode == null) {
      ...
      import_build5.isDev && vnode_setProp(vNewNode, DEBUG_TYPE, "P" /* Projection */);
      import_build5.isDev && vnode_setProp(vNewNode, "q:code", "expectSlot" + count++);
      return false;
  ...
  function expectVirtual(type, jsxKey) {
    ...
    import_build5.isDev && vnode_setProp(vNewNode || vCurrent, DEBUG_TYPE, type);
  }
  ...
  function insertNewComponent(host, componentQRL, jsxProps) {
    ...
    const jsxNode2 = jsxValue;
    import_build5.isDev && vnode_setProp(vNewNode, DEBUG_TYPE, "C" /* Component */);
  ...
  function insertNewInlineComponent() {
    ...
    const jsxNode2 = jsxValue;
    import_build5.isDev && vnode_setProp(vNewNode, DEBUG_TYPE, "I" /* InlineComponent */);
...
var componentQrl = (componentQrl2) => {
  function QwikComponent(props, key, flags = 0) {
    ...
    const hash2 = qTest ? "sX" : componentQrl2.$hash$.slice(0, 4);
...
function getDomContainerFromQContainerElement(qContainerElement) {
  ...
  if (!container) {
    ...
    qElement.setAttribute(QContainerAttr, "resumed" /* RESUMED */);
      ...
      try {
        ...
        while (idx < unclaimedProjections.length) {
          ...
          if (value instanceof SsrComponentFrame) {
            ...
            await (0, import_core3._walkJSX)(this, children, {
              allowPromises: true,
